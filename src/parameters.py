...
Q_park = np.diag([1.0, 1.0, 2.0, 0.1]) # State Cost Matrix
Qf_park = np.diag([1.0, 1.0, 1.0, 0.1]) # Final State Cost Matrix
R_park = np.diag([1.0, 0.1]) # Control Input Cost Matrix
Rd_park = np.diag([0.1, 0.1]) # Control Input Difference Cost Matrix