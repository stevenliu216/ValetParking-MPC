...
Q_park = np.diag([1.0, 1.0, 1.0, 0.0]) # State Cost Matrix
Qf_park = np.diag([1.0, 1.0, 1.0, 0.0]) # Final State Cost Matrix
R_park = np.diag([1.0, 0.01]) # Control Input Cost Matrix
Rd_park = np.diag([1.0, 0.01]) # Control Input Difference Cost Matrix